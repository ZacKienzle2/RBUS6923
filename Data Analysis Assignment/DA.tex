...
\begin{table}[H]
	\centering
	\input{outputs/q1a_regression.tex}
...
\begin{table}[H]
	\centering
	\input{outputs/q1c_quadratic.tex}
...
\begin{figure}[H]
	\centering
	\input{outputs/q2_ece_coefs.pgf}
	\caption{Market valuation of ECE by polluter type with 95\% confidence intervals. The low-polluter coefficient includes zero; the high-polluter coefficient is significantly negative.}\label{fig:q2_ece}
\end{figure}
...
\begin{table}[H]
	\centering
	\input{outputs/q3b_clustered.tex}
...
\begin{table}[H]
	\centering
	\input{outputs/q3c_fixed_effects.tex}
...
\begin{figure}[H]
	\centering
	\input{outputs/q4_structural.pgf}
